...
const ListingDetail = () => {
  ...
  const totalGuests = guests.adults + guests.children;
   ...
   const calculateTotalPrice = () => {
    if (!selectedDates.startDate || !selectedDates.endDate) return listing.pricePerNight;
    
    const diffTime = Math.abs(selectedDates.endDate - selectedDates.startDate);
  ...
  const getAmenityIcon = (amenity) => {
    switch (amenity) {
      case "toilet_paper": return <FiDroplet className="text-xl text-black" />;
      case "soap": return <FiUmbrella className="text-xl text-black" />;
      case "towels": return <FiUser className="text-xl text-black" />;
      case "pillows": return <FiPocket className="text-xl text-black" />;
      case "linens": return <GiWoodenChair className="text-xl text-black" />;
      case "wifi": return <CiWifiOn className="text-xl text-black" />;
      case "kitchen": return <MdKitchen className="text-xl text-black" />;
      case "parking": return <MdLocalParking className="text-xl text-black" />;
      case "pool": return <MdPool className="text-xl text-black" />;
      case "tv": return <FiTv className="text-xl text-black" />;
      case "air_conditioning": return <FiThermometer className="text-xl text-black" />;
      case "smoke_alarm": return <FiAlertTriangle className="text-xl text-black" />;
      case "first_aid": return <FiPlusSquare className="text-xl text-black" />;
      default: return null;
    }
  };
  ...
  return (
    ...
    <div className="max-w-[1800px] mx-auto px-4 sm:px-8 py-8">
      ...
      <div className="mb-8 flex justify-between items-start">
        ...
        >
          <FiHeart className={`w-6 h-6 ${isFavorite ? 'fill-rose-500 text-rose-500' : 'text-gray-600'}`} />
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="relative">
                  ...
                  {showReadMore && (
                    <button
                      ...
                      className="text-rose-500 hover:text-rose-700 font-medium mt-2"
                    >
                ...
                <div className="p-6 border border-gray-200 rounded-xl">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">You'll have the place to yourself</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    <FiUsers className="text-2xl text-rose-500" />
                    <div>
                      <h3 className="font-medium">Enhanced cleaning</h3>
                      <p className="text-gray-500 text-sm">This host committed to Airbnb's cleaning process</p>
                    </div>
                  </div>
                </div>
              </div>
                            ...
                            {user && (user._id === review.user._id || user.role === "admin") && (
                              <div className="relative">
                                ...
                                {showDeleteConfirm === review._id && (
                                  <div className="absolute right-0 top-6 bg-white p-2 rounded shadow-lg border border-gray-200 z-10">
          ...
          <section className="mb-12">
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-xl font-semibold mb-1">Hosted by {listing.host.name}</h2>
                    <p className="text-gray-600 text-sm mb-2">
                      Joined in {new Date(listing.host.createdAt).getFullYear()}
                    </p>
                  </div>
                  <button className="px-4 py-1 border border-gray-300 rounded-lg text-sm font-medium hover:border-gray-400 transition">
                    Contact
                  </button>
                </div>
                <div className="flex space-x-4 mb-3">
                  <div className="flex items-center text-sm">
                    ...
                    <span>{listing.host.ratingCount || 0} reviews</span>
                  </div>
                  <div className="flex items-center text-sm">
                ...
                <p className="text-gray-700 text-sm mb-3">
                  {listing.host.bio || "Experienced host with a passion for hospitality."}
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="relative">
          <div className="sticky top-6">
            <div className="border border-gray-200 rounded-xl shadow-lg p-4 w-80">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold">
                  ${listing.pricePerNight} <span className="text-gray-600 font-normal">night</span>
                </h3>
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center py-3 border-t border-gray-200">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="w-6 text-center text-sm">{guests.infants}</span>
                        <button 
              ...
              <button 
                ...
                disabled={!selectedDates.startDate || !selectedDates.endDate} onClick={handleReserveButton}
              >
                Reserve
              </button>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-600">${listing.pricePerNight} x {totalDays()}</span>
                  <span>${listing.pricePerNight * totalDays()}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                 ...
                 <div className="flex justify-between">
                  <span className="text-gray-600">One Guest Cost</span>
                  <span>$10</span>
                </div>
